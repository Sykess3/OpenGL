...
namespace test
{
	...
	{
	public:
		std::vector<std::shared_ptr<RenderData>> GetRenderData(const std::vector<Portion>& portions, float uvStep);
	...
	private:
		...
		std::vector<std::shared_ptr<RenderData>> GenerateArrayBufferInternal();
